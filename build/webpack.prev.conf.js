...
var alphaWebpackConfig = require('./webpack.alpha.conf')
var HtmlWebpackPlugin = require('html-webpack-plugin')
var ExtractTextPlugin = require('extract-text-webpack-plugin')
var env = config.preview.env

var webpackConfig = merge(alphaWebpackConfig, {
  module: {
  ...
  devtool: config.preview.productionSourceMap ? '#source-map' : false,
  output: {
