...
import {
  FETCH_PROJECTS_OUT,
  FETCH_PROJECTS_OUT_TASTE,
  FETCH_PROJECTS_OUT_NEW,
  FETCH_PROJECTS_OUT_BEST,
  FETCH_PROJECTS_OUT_HOT,
  CLEAR_PROJECT_OUT
} from './../../mutation-types'

export const mutations = {
  [FETCH_PROJECTS_OUT] (state, data) {
  ...
  [FETCH_PROJECTS_OUT_TASTE] (state, data) {
  ...
  [FETCH_PROJECTS_OUT_NEW] (state, data) {
  ...
  [FETCH_PROJECTS_OUT_BEST] (state, data) {
  ...
  [FETCH_PROJECTS_OUT_HOT] (state, data) {
