<template>
  <div class="gallery">
    <div class="gallery-items-wrap" ref="wrap">
      <slot></slot>
    </div>
    <div class="gallery-indicators" v-show="showIndicators">
      <div class="gallery-indicator" v-for="(page, i) in pages"
...
<style lang="css" scoped>
  ...
  .gallery-items-wrap > div.is-active {
